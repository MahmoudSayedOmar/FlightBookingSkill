...
using Flight_Booking_Skill.Adapters;
using Flight_Booking_Skill.Bots;
using Flight_Booking_Skill.Dialogs;
using Flight_Booking_Skill.Responses.Main;
using Flight_Booking_Skill.Responses.Sample;
...
namespace Flight_Booking_Skill
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(sp => new ResponseManager(
                ...
                new SharedResponses(),
                new SampleResponses(),
                new FlightBookingSharedResponses()));
