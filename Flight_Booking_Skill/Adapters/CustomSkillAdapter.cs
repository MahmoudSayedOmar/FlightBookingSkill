...
namespace Flight_Booking_Skill.Adapters
{
    public class CustomSkillAdapter : SkillWebSocketBotAdapter
    {
            ...
            IBotTelemetryClient telemetryClient)
        {
            ...
            Use(new SkillMiddleware(userState, conversationState, conversationState.CreateProperty<DialogState>(nameof(Flight_Booking_Skill))));
        }
    }
}
